...
interface UpdateMeterDialogProps {
  open: boolean
  /** The bike's last known odometer reading (km). */
  currentMeter: number
  onClose: () => void
...
/**
 * Quick way to bump a bike's odometer without logging a tuning, so the
 * "distance since last tuning" / "due" figures stay current.
 */
      ...
      <DialogContent>
        <Stack spacing={2} sx={{ mt: 1 }}>
          <Typography variant="body2" color="text.secondary">
            Enter the bike's latest odometer reading to refresh how far it's been ridden since the
            last tuning.
          </Typography>
          <TextField
